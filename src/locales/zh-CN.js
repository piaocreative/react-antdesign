...
export default {
  ...
  'menu.data': '数据',
  'menu.analytics':'分析',
  'menu.analytics.authorization':'授权',
  'menu.analytics.rates':'费率',
  'menu.analytics.analytic#1':'分析 #1',
  'menu.analytics.analytic#2':'分析 #2',
  'menu.analytics.analytic#3':'分析 #3',
  'menu.analytics.analytic#4':'分析 #4',
  'menu.analytics.worldwide':'世界各地',
  'menu.alerts':'警报',
  'menu.reports':'报告',
  //inserted end
